defmodule LedgemechanicusWeb.DocumentLive.Show do
  ...
  @impl true
  def handle_info(
        {:updated, %Ledgemechanicus.Documents.Document{id: id} = document},
  ...
  def handle_info(
        {:deleted, %Ledgemechanicus.Documents.Document{id: id}},
        %{assigns: %{document: %{id: id}}} = socket
      ) do
    {:noreply,
     socket
