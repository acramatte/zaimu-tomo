defmodule Ledgemechanicus.DocumentProcessing.DocumentOCR do
  @moduledoc """
  ...
  alias Ledgemechanicus.DocumentProcessing.ExtractedData
  require Logger
  ...
  defp upload(filepath) do
    config = Application.fetch_env!(:ledgemechanicus, :mistral)
