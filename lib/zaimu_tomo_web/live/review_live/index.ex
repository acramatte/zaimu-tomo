    ...
    <div class="card">
      ...
      <div class="feed" id="reviews-feed" phx-update="stream">
        <div
          ...
          id={dom_id}
          class={"feed-item #{pill_status(review.review_status)}"}
        >
          ...
          <div class="body">
            ...
            <div class="desc">
              <span class="amt">
                {if data.amount_to_pay_cents && data.currency,
          ...
          <div class="actions">
            ...
            <a :if={review.review_status != "pending"} class="btn sm" href={~p"/reviews/#{review}"}>
              View
            </a>
