defmodule ZaimuTomo.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind zaimu_tomo", "esbuild zaimu_tomo"],
      "assets.deploy": [
        "tailwind zaimu_tomo --minify",
        "esbuild zaimu_tomo --minify",
        "phx.digest"
      ],
