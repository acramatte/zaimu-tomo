defmodule Ledgemechanicus.DocumentProcessingTest do
  use Ledgemechanicus.DataCase, async: true

  alias Ledgemechanicus.DocumentProcessing
  alias Ledgemechanicus.Documents
  alias Ledgemechanicus.AccountsFixtures
  ...
  describe "document processing workflow" do
    test "start_saga/0 starts the Saga GenServer" do
      ...
      assert GenServer.call(Ledgemechanicus.DocumentProcessing.Saga, :status) == :running
    end
    ...
    test "process_document/1 starts supervised OCR task" do
      ...
      case Ledgemechanicus.DocumentProcessing.start_ocr_supervisor() do
  ...
  describe "DocumentOCR processing" do
    test "DocumentOCR.process/1 handles file processing" do
      ...
      result = Ledgemechanicus.DocumentProcessing.DocumentOCR.process("non_existent_file.pdf")
